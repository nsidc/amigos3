...
import sys
import traceback
from monitor import get_schedule_health, put_to_power_sleep, put_to_inactive_sleep, clear_cached, get_system_performance, has_slept, amigos_Unit
...
printf("\n" + " "*25 + "*****   *****   *****" + "\n" +
       " "*10 + "Wait!! please, Give your feedbacks to my creators and keep earth healthy" + "\n"+" "*30 + "***** ***** *****" + "\n", date=True)
...
class winter():
    ...
    def sbd(self):
        ...
        # # box B
            ...
            self.sched_winter.every().day.at("00:04").do(sbd_send)
        # # box C
        elif amigos_Unit() == "C":
            self.sched_winter.every().day.at("00:06").do(sbd_send)
