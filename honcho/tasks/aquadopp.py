...
from honcho.config import (AQUADOPP_IDS, AQUADOPP_RECENT_SAMPLES, DATA_TAGS,
                           TIMESTAMP_FMT)
from honcho.core.imm import REMOTE_RESPONSE_END, active_line, imm_components
...
@task
def execute():
    samples = get_recent_samples(device_ids=AQUADOPP_IDS, n=AQUADOPP_RECENT_SAMPLES)
