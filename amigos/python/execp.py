...
def welcome():
    ...
    printf(
        ...
        + "\n"
        + " " * 20
        + "Hi there, I am the Amigos Unit {0} version III.".format(unit)
        + " " * 10
        + "\n"
        + " " * 10
        + "Here, you will find all my actions since I was powered on."
        + " " * 10
        + "\n"
        + " " * 30
        + "*****   *****   *****"
    ...
    printf(
        ...
        + "\n"
        + " " * 10
        + "Wait!! please, Give your feedbacks to my creators and keep earth cleaned"
        + "\n"
        + " " * 30
        + "*****   *****   *****"
        + "\n",
...
def terminateProcess(signalNumber, frame):
    ...
    printf(
        "received (SIGTERM),  terminating the scheduler. "
        "Total power consumed is {0}".format(str(power)[0:-6])
    )
    sys.exit(0)
