    ...
    for line in f:
        if "0R1" in line:
            ...
            with open("Weather_Data_Human.txt", "a") as h1:
                ...
                h1.write("Current Date and Time: " +
                         now.strftime("%Y-%m-%d %H:%M:%S\n"))
                h1.write("Wind Direction Minimum (Degrees): " +
                         str(string_array1Final[0]) + "  |  ")
                h1.write("Wind Direction Average (Degrees): " +
                         str(string_array1Final[1]) + "  |  ")
                h1.write("Wind Direction Maximum (Degrees): " +
                         str(string_array1Final[2]) + "  |  ")
                h1.write("Wind Speed Minimum (m/s): " +
                         str(string_array1Final[3]) + "  |  ")
                h1.write("Wind Speed Average (m/s): " +
                         str(string_array1Final[4]) + "  |  ")
                h1.write("Wind Speed Maximum (m/s): " +
                         str(string_array1Final[5]) + "  |  \n\n\n")
        elif "0R2" in line:
            ...
            with open("Weather_Data_Human.txt", "a") as h2:
                ...
                h2.write("Current Date and Time: " +
                         now.strftime("%Y-%m-%d %H:%M:%S\n"))
                h2.write("Air Temperature (C): " + str(string_array2Final[0]) + "  |  ")
                h2.write("Relative Humidity (%RH): " +
                         str(string_array2Final[1]) + "  |  ")
                h2.write("Air Pressure (hPa): " +
                         str(string_array2Final[2]) + "  |  \n\n\n")
        elif "0R3" in line:
            ...
            with open("Weather_Data_Human.txt", "a") as h3:
                ...
                h3.write("Current Date and Time: " +
                         now.strftime("%Y-%m-%d %H:%M:%S\n"))
                h3.write("Rain Accumulation (mm): " +
                         str(string_array3Final[0]) + "  |  ")
                h3.write("Rain Duration (s): " + str(string_array3Final[1]) + "  |  ")
                h3.write("Rain Intensity (mm/hour): " +
                         str(string_array3Final[2]) + "  |  ")
                h3.write("Rain Peak Intensity (mm/hour): " +
                         str(string_array3Final[6]) + "  |  ")
                h3.write("Hail Accumulation (hits/cm^2): " +
                         str(string_array3Final[3]) + "  |  ")
                h3.write("Hail Duration (s): " + str(string_array3Final[4]) + "  |  ")
                h3.write("Hail Intensity (hits/cm^2/hour): " +
                         str(string_array3Final[5]) + "  |  ")
                h3.write("Hail Peak Intensity (hits/cm^2/hour): " +
                         str(string_array2Final[7]) + "  |  \n\n\n")
        elif "0R5" in line:
            ...
            with open("Weather_Data_Human.txt", "a") as h5:
                ...
                h5.write("Current Date and Time: " +
                         now.strftime("%Y-%m-%d %H:%M:%S\n"))
                h5.write("Heating Temperature (C): " +
                         str(string_array5Final[0]) + "  |  ")
                h5.write("Heating Voltage (V): " + str(string_array5Final[1]) + "  |  ")
                h5.write("Supply Voltage (V): " + str(string_array5Final[2]) + "  |  ")
                h5.write("3.5 Volts Reference Voltage (V): " +
                         str(string_array5Final[3]) + "  |  \n\n\n")
