...
#define CSIDE0  0x30000000
#define CSIDE1  0x30400000
...
/* CSIDE0 0x3000_0000 OR CSIDE1 0x3040_0000  */
...
printf("READ from CSIDE0 for 60000 times\n");
	for (times=900000;times > 1;times--)	
	{
      	read_result = *((unsigned long *) virt_addr);
	}

printf("Wite to CSIDE0 for 60000 times\n");
	for (times=900000;times > 1;times--)
	{	  
